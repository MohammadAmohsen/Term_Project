...
namespace Term_Project.AdminAspx
{
    public partial class AdminMessages : System.Web.UI.Page
    {
        ...
        public void ViewSent(String tags)
        {
            ...
            */
            String tag1 = ds.Tables[0].Rows[0]["TagsId"].ToString();
        ...
        //    newEmail.senderName = Session["UserId"].ToString();
        //    newEmail.subject = Subject;
        //    newEmail.emailBody = Body;
        //    newEmail.createdTime = Time;

        //    SqlCommand sqlCommandM = new SqlCommand();

        //    sqlCommandM.CommandType = CommandType.StoredProcedure;
        //    sqlCommandM.CommandText = "SelectUserIDEmailCreateUser";
        ...
        //            sqlCommand3A.CommandText = "SelectUserIDFromUsersEMAILASP";
        ...
        //            sqlCommand4A.CommandText = "InsertEmailEverythingMEMAILASPX";

        //            SqlParameter SenderName = new SqlParameter("@SenderName", newEmail.senderName);
        //            SenderName.Direction = ParameterDirection.Input;
        //            sqlCommand4A.Parameters.Add(SenderName);


        //            SqlParameter ReceiverName = new SqlParameter("@ReceiverName", newEmail.recieverName);
        //            ReceiverName.Direction = ParameterDirection.Input;
        //            sqlCommand4A.Parameters.Add(ReceiverName);

        //            SqlParameter Subject1 = new SqlParameter("@Subject", newEmail.subject);
        ...
        //            SqlParameter Time1 = new SqlParameter("@CreatedTime", newEmail.createdTime);
        ...
        //            sqlCommand5A.CommandType = CommandType.StoredProcedure;
        //            sqlCommand5A.CommandText = "SelectEmailIDFromEmail";

        //            SqlParameter recieverName = new SqlParameter("@ReceiverName", newEmail.recieverName);
        ...
        //            sqlCommand6A.CommandType = CommandType.StoredProcedure;
        //            sqlCommand6A.CommandText = "SelectTagsIDFROMTagsEMAIL";

        //            SqlParameter recieverName1 = new SqlParameter("@ReceiverName", newEmail.recieverName);
        ...
        //            DataSet ds2 = db.GetDataSetUsingCmdObj(sqlCommand6A);
        //            int tagId = Convert.ToInt32(ds2.Tables[0].Rows[0]["TagsId"]);
        //            string flag = "No";
        ...
        //            sqlCommand7A.CommandType = CommandType.StoredProcedure;
        //            sqlCommand7A.CommandText = "InsertEverythingIntoReceipt";

        //            SqlParameter ReceiverName2 = new SqlParameter("@ReceiverName", Convert.ToInt32(newEmail.recieverName));
        ...
        //            SqlParameter Flag1 = new SqlParameter("@Flag", flag);
        //            Flag1.Direction = ParameterDirection.Input;
        //            sqlCommand7A.Parameters.Add(Flag1);
        ...
        //            sqlCommand9A.CommandText = "SelectEmailIDFromEmail";

        //            SqlParameter ReceiverName4 = new SqlParameter("@ReceiverName", newEmail.recieverName);
        ...
        //            sqlCommand10A.CommandText = "SelectTagsIdShowMailEmail";
        ...
        //            int tagID = Convert.ToInt32(data4.Tables[0].Rows[0]["TagsId"]);
        //            //-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
        ...
        //            sqlCommand11A.CommandText = "InsertEverythingIntoReceipt";
        ...
        //            SqlParameter Flag2 = new SqlParameter("@Flag", flag);
        //            Flag2.Direction = ParameterDirection.Input;
        //            sqlCommand11A.Parameters.Add(Flag2);
